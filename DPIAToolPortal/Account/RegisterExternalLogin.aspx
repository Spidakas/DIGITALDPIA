<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Application.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="InformationSharingPortal.RegisterExternalLogin" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ModelErrorMessage runat="server" ModelStateKey="Provider" CssClass="bg-danger" />
        ...
        <fieldset>
            ...
            <ol>
                <li class="email">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="userName" SetFocusOnError="true"
                        Display="Dynamic" ErrorMessage="User name is required" ValidationGroup="NewUser" />
                    
                    <asp:ModelErrorMessage runat="server" ModelStateKey="UserName" CssClass="bg-danger" />
